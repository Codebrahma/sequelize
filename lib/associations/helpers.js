...
function mixinMethods(association, obj, methods, aliases) {
  ...
  for (const method of methods) {
    ...
    if (!obj[association.accessors[method]]) {
      ...
      const associationName = association.inspect();

      obj[association.accessors[method]] = function() {
        const instance = this;
        const value = instance.get(associationName);
        const currentArguments = Array.from(arguments);
        ...
        const args = [instance].concat(currentArguments);
